          ...
          <div className="bg-white/90 backdrop-blur-xl p-8 md:p-10 rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.08)] border border-gray-100 w-full max-w-md text-center relative overflow-hidden transition-transform duration-500 hover:-translate-y-1">
             ...
             <ul className="text-left space-y-4 mb-10">
               <li className="flex items-center text-gray-700 font-bold">
                 <div className="w-8 h-8 rounded-xl bg-indigo-50 flex items-center justify-center mr-4 text-indigo-600">✓</div>
            ...
            <button 
              ...
              className="w-full px-6 py-4 bg-gradient-to-r from-indigo-600 to-violet-600 text-white rounded-2xl font-bold text-lg transition-all duration-200 ease-out hover:shadow-[0_10px_30px_rgba(79,70,229,0.4)] hover:-translate-y-0.5 active:translate-y-0.5 active:scale-[0.98] active:shadow-[inset_0_3px_8px_rgba(0,0,0,0.2)] focus:outline-none focus:ring-4 focus:ring-indigo-500/30 disabled:opacity-70"
            >
            ...
            <div className="mt-6 flex justify-center items-center gap-2 text-xs font-bold text-gray-400">
               ...
               Secured by <span className="text-[#635BFF] font-extrabold ml-1 tracking-wide">stripe</span>
            </div>
          </div>
        </div>
      ) : (
